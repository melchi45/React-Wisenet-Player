...
export var AuthException = (function () {
  'use strict';
  var version = '1.0.0';
  ...
  function AuthException() {
    ...
    if (!(this instanceof AuthException)) {
      return new AuthException(arguments);
    }
    var error,
    ...
    //access to AuthException.prototype.name
  ...
  // but we need to raise the exception when AuthException instance is created.
  AuthException.prototype = Object.create(Error.prototype, {
    //fixes the link to the constructor (ES5)
    constructor: setDescriptor(AuthException),
