...
export var RTCPError = (function () {
  ...
  function RTCPError() {
    ...
    if (!(this instanceof RTCPError)) {
      return new RTCPError(arguments);
    }
    var error,
    ...
    //access to RTCPError.prototype.name
  ...
  // but we need to raise the exception when RTCPError instance is created.
  RTCPError.prototype = Object.create(Error.prototype, {
    //fixes the link to the constructor (ES5)
    constructor: setDescriptor(RTCPError),
