...
export var FisheyeError = (function () {
  'use strict';
  var version = '1.0.0';

  //constructor
  function FisheyeError() {
    //enforces 'new' instance
    if (!(this instanceof FisheyeError)) {
      return new FisheyeError(arguments);
    }
    var error,
    ...
    //access to FisheyeError.prototype.name
  ...
  // but we need to raise the exception when FisheyeError instance is created.
  FisheyeError.prototype = Object.create(Error.prototype, {
    //fixes the link to the constructor (ES5)
    constructor: setDescriptor(FisheyeError),
