...
export var RTSPError = (function () {
  ...
  function RTSPError() {
    ...
    if (!(this instanceof RTSPError)) {
      return new RTSPError(arguments);
    }
    var error,
    ...
    //access to RTSPError.prototype.name
  ...
  // but we need to raise the exception when RTSPError instance is created.
  RTSPError.prototype = Object.create(Error.prototype, {
    //fixes the link to the constructor (ES5)
    constructor: setDescriptor(RTSPError),
